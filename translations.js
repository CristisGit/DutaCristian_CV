const translations = {
    en: {
        ...
        about_story: "I am a results-driven Automation Developer specializing in UiPath. My background is unique: I transitioned from 9 years of Civil Engineering to IT. This engineering foundation allows me to approach automation with rigorous logic, structural thinking, and attention to detail.",
        ...
        job1_story: "At UBIO, I faced the challenge of automating uncollaborative third-party travel websites (flight & hotel verticals). Standard selectors failed due to dynamic changes. <br><br><strong>My Solution:</strong> I engineered adaptable iterative algorithms using custom JavaScript and Regex to 'read' the page structure dynamically rather than relying on static IDs. This ensured the robots could complete complex booking flows even when the target website changed its layout, achieving high stability rates.",

        date_2: "May 2023 - Aug 2023",
        job2_preview: "Mapped end-to-end business processes and integrated Chatbots...",
        job2_story: "In this role, I moved beyond simple task execution to process optimization. I collaborated within Agile teams to map out end-to-end business processes. <br><br><strong>Key Achievement:</strong> I integrated RPA robots with Chatbot interfaces and API endpoints. This allowed for real-time data processing and drastically reduced the time spent on manual data entry. I also standardized messy data feeds from external sources into a universal schema.",

        date_3: "Apr 2021 - May 2023",
        job3_preview: "Utilized JavaScript and Regex for complex web scraping...",
        job3_story: "At Paddy Power Betfair, the focus was on handling high volumes of data with precision. I utilized a diverse technical stack including advanced CSS selectors and Regex to extract sophisticated web data. <br><br><strong>The Daily Grind:</strong> I managed the continuous optimization of live robots, proactively identifying bottlenecks and refactoring code to improve performance before issues impacted the business.",
